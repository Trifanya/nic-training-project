...
public interface CommentMapper {
    String FIND_TASK_BY_ID_METHOD_NAME = "dev.trifanya.mybatis.mapper.TaskMapper.findTaskById";
    String FIND_USER_BY_ID_METHOD_NAME = "dev.trifanya.mybatis.mapper.UserMapper.findUserById";
