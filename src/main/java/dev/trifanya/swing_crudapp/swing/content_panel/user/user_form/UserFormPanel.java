package dev.trifanya.swing_crudapp.swing.content_panel.user.user_form;
...
import dev.trifanya.swing_crudapp.validator.UserValidator;
    ...
    public void initSubmitButton() {
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    userValidator.validateUser(user, passwordConfirmationField.getText());
                } catch (Exception exception) {
                    JOptionPane.showMessageDialog(
                            UserFormPanel.this, exception.getMessage(),
                ...
                if (currentUser == null) {
                    ...
                    JOptionPane.showMessageDialog(UserFormPanel.this, "Пользователь успешно зарегистрирован", "Сообщение", JOptionPane.INFORMATION_MESSAGE);
                    contentLayeredPane.putPanelOnTop("CREDENTIALS FORM");
                    clearUserForm();
                } else {
