package dev.trifanya.main_frame.content.task_form;
...
public class TaskFormPanel extends JPanel {
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (currentTask == null) {
                    ...
                    taskClient.updateTaskInfo(taskToSave);
                }
            }
        });
     ...
     */
    public void fillTaskForm(TaskDTO task) {
        titleField.setText(task.getTitle());
        UserDTO user = userClient.getUserByEmail(task.getPerformerEmail());
    ...
    public void setCurrentTask(TaskDTO task) {
